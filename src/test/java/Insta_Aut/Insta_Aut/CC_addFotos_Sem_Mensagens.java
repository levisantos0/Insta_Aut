...
public class CC_addFotos_Sem_Mensagens {
	public int Random() {
	...
	public void test(dados d) {
		...
		try {
			...
			navegador.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); // Espera aparecer o botão de gerar
																				// usuário
			navegador
					.findElement(By
							.xpath("/html/body/div[1]/section/main/div/div/div[1]/div/form/div[5]/div/div/div/button"))
					.click(); // gera o usuário
			navegador
					.findElement(
							By.xpath("/html/body/div[1]/section/main/div/div/div[1]/div/form/div[6]/div/label/input"))
			...
			wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
					By.xpath("/html/body/div[1]/section/main/div/div/div[1]/div/div[6]/button")));
			...
			navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/div/div[1]/div/div[6]/button")).click(); // Clica
																														// para
																														// cadastrar
																														// e
																														// espera
			...
			wait.until(ExpectedConditions
					.visibilityOfAllElementsLocatedBy(By.xpath("/html/body/div[4]/div/div/div/div[3]/button[2]")));// Espera
																													// o
																													// botão
																													// 'agora
																													// não'
			navegador.findElement(By.xpath("/html/body/div[4]/div/div/div/div[3]/button[2]")).click(); // Agora não
			navegador.findElement(By.xpath("/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[5]/span/img"))
					.click(); // Clica no ícone do perfil
			navegador.findElement(
					By.xpath("/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div[2]/"
							+ "div[2]/a[3]/div/div[2]/div/div/div/div"))
					.click();// Clica em configurações

			String user = navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/article/div/div[2]/h1"))
					.getText();
			...
			navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/article/form/div[7]/div/div/input"))
					.sendKeys(Keys.chord(Keys.CONTROL, "a"), Keys.BACK_SPACE); // Apaga o telefone
			PegandoDad p = new PegandoDad();
			navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/article/form/div[6]/div/div/input"))
					.sendKeys(p.emailAleatorio()); // Põe um email aleatório

			switch (this.Random1()) { // Gera uma bio
			case 1:
				navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/article/form/div[4]/div/textarea"))
						.sendKeys("21 anos :')\r\n" + "Salvador - BA\r\n"
			...
			navegador.findElement(By.xpath("/html/body/div[1]/section/main/div/article/form/div[10]/div/div/button"))
					.click();// Clica para salvar
